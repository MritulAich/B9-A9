...
const Footer = () => {
    return (
        <footer className="footer mt-20 footer-center p-10 bg-teal-200 text-base-content rounded">
  <nav className="grid grid-flow-col gap-5">
    <a className="link link-hover text-xl">About Imperial</a>
    <a className="link link-hover text-xl">Contact</a>
    <a className="link link-hover text-xl">News</a>
  </nav> 
  <nav>
  ...
  <aside>
    <p>Copyright © 2024 - All right reserved by Imperial Corporation Ltd</p>
  </aside>
</footer>
    );
};
